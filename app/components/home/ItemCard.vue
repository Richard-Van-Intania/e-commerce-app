...
<template>
    <div class="w-[295px] flex flex-col gap-2">
        <div class="h-[298px] cursor-pointer" v-on:click="emit('handle-click')"><NuxtImg v-bind:src="props.item.source" class="rounded-4xl"></NuxtImg></div>
